...
async def load_knowledge_base(kb_dir: str = None) -> None:
    """Load and index knowledge base documents locally in milliseconds using NumPy."""
    ...
    # 1. Read and chunk markdown documents
    chunks = []
    ...
    # 2. Build local TF-IDF vector index using pure NumPy
    ...
    print(f"Knowledge base indexed locally: {len(chunks)} chunks in {len(vocab)} dimensions!")
